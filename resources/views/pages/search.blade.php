    ...
    <section class="bread-crumb">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Search: {{ Request::get('search_key') }}</li>
            </ol>
        </nav>
    </section>
    ...
    <div class="site-search">
        ...
        <section class="section-products">
            <div class="section-header">
                <h2 class="section-title">Product <span>( {{ $data['products']->count() }} Product )</span></h2>
            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 animate">
                                                <div class="product-details">
                                                    <p><strong><i class="fas fa-tv"></i> Screen:
                                                        </strong>{{ $product->monitor }}</p>
                                                    <p><strong><i class="fas fa-camera-retro"></i> Front camera:
                                                        </strong>{{ $product->front_camera }}</p>
                                                    <p><strong><i class="fas fa-camera-retro"></i> Rear camera:
                                                    ...
                                                    <p><strong><i class="fas fa-hdd"></i> Internal memory:
                                                    ...
                                                    @endif
                                                    <p><strong><i class="fas fa-battery-full"></i> Battery capacity:
        ...
        <section class="section-posts">
            <div class="section-header">
                <h2 class="section-title">Posts <span>( {{ $data['posts']->count() }} bài viết )</span></h2>
            </div>
            <div class="section-content">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-6">
                                <div class="item-post">
                                    <a href="{{ route('post_page', ['id' => $post->id]) }}" title="{{ $post->title }}">
                                        ...
                                        <div class="date-post">
                                            Date Submitted: {{ date_format($post->created_at, 'd/m/Y') }}
                                        </div>
                                    </a>
                                </div>
                            </div>
