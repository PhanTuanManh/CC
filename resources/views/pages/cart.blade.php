    ...
    <div class="site-cart">
        ...
        <section class="section-cart">
            <div class="section-header">
                <h2 class="section-title">Cart <span>( {{ $cart->totalQty }} Product )</span></h2>
            </div>
                        ...
                        <div class="col-md-4">
                            <div class="total-price">
                                ...
                                <div class="btn-action">
                                    <button title="Thanh Toán Ngay" data-url="{{ route('show_checkout') }}">Pay
                                        Now</button>
                                    <a href="{{ route('products_page') }}" class="btn-btn-default"
                                        title="Tiếp Tục Mua Hàng">Continue Shopping</a>
                                </div>
                            </div>
                        </div>
                    </div>
